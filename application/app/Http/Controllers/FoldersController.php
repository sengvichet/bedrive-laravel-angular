...
class FoldersController extends Controller {
	...
	public function index() {
        ...
        // } else {
            ...
            return User::where('permissions', '!=', 'null')->first()
                ->hasMany('App\Folder')->with('labels')->get();
        // }
	}
	...
	public function show($name)
	{
        ...
        // return $folder;
        $folder = User::where('permissions', '!=', 'null')->first()
        ->hasMany('App\Folder')
        ->with(['files' => function($q)
        {
            $limit = App::make('Settings')->get('dash_files_num', 50);
        ...
        // print_r('jjjjjjjjjjjjjj'.Auth::user());
        // print_r('I want to find Admin User====>'.User::where('permissions', '!=', 'null')->first());exit;
        return $folder;
	}
